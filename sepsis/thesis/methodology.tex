...
stated two paragraphs above --- that the correction denominator is the number of
contrasts computed, not the number selected for presentation --- because
restricting E1 from thirty computed contrasts to
\pcNSubgroupContrasts{} is on its face the manoeuvre that rule prohibits.
