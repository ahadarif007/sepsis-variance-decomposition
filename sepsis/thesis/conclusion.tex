...
\begin{enumerate}
    ...
    \pcHTwoNTerms{} shared covariates are unstable across labels (\pcHTwoNSign{} by sign, including vasopressor exposure, and \pcHTwoNMag{}
    ...
    databases, and which emits the numbers in this document as generated
...
membership --- the three variants agree at $\kappa = \pcKappaVsBA$ on which
patients are septic --- and through onset timing, which fixes what a real-time
model can be asked to anticipate at all. Those are the channels the reported
