...
requiring both limbs is not what makes the label hard. Sepsis-3 with a better
clock is easier again (\pcAltAurocFullPrimaryF{} against \pcAurocPrimaryB), and
that is a like-for-like comparison because Variant F holds the labelled stays
fixed and changes only the clock. Variant D's higher figure is not offered in
