...
discrimination. External transport has the second-largest point estimate,
...
inconclusive in an informative way. External discrimination is \pcExtAurocPrimaryB{} on eICU-CRD
...
across labels, and the treatment-independent label added under Protocol
Amendment~9 shows a degradation of the same order on \pcExtAltNEvents{} events
across the whole of eICU-CRD. Every external point estimate is below its
