...
utility ceiling moved from 0.039 to 0.031 and the model-class gap from 0.0129 to
0.0165 for exactly this reason, with no defect involved.
...
\begin{verbatim}
git checkout <tag>
diff <(git show <tag>:sepsis/thesis/generated/pipeline_constants.tex) \
     sepsis/thesis/generated/pipeline_constants.tex
\end{verbatim}
