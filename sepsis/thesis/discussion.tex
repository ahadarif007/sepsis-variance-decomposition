...
\begin{enumerate}
    ...
    For H1, H4 and H6 the correction determines nothing: each carries an
    adjusted $p$-value of 1.000 and each fails on its point estimate. H5 is the
    exception on precision --- its adjusted value is \pcHFivePHolm, and it fails
