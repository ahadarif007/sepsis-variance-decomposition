...
\begin{enumerate}
  \item \textbf{C1 (Label variance).} The first three-variant label sensitivity
  analysis for a dynamic survival model on MIMIC-IV, following Cohen et al.\
  \cite{cohen2024subtle} and Dutta et al.\ \cite{dutta2026performance}.
  ...
  \item \textbf{C5 (Equity-by-label analysis).} The first study to examine both
  model performance disparities and label sensitivity across demographic
  subgroups, following Wang et al.\ \cite{wang2022equity}.
...
plan.
Chapter~\ref{ch:design} explains the pipeline architecture and its thirteen
scripts.
