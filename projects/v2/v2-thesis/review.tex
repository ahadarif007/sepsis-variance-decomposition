...
\begin{table}[H]
    ...
    ``to the best of our knowledge'' and are bounded by the coverage above.}
...
after clinical recognition are retained, falling to 0.47 --- worse than chance
...
\begin{table}[H]
    \centering\small
    \begin{tabular}{p{3.1cm}p{5.6cm}p{4cm}}
        \toprule
