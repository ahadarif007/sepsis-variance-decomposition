...
This chapter summarises the evidence base that drove the design of this study.
...
extracts the seven evidence strands directly load-bearing for the present study's
design choices.
...
The premise that a model can be assessed on ``the MIMIC-IV sepsis cohort'' as
though it were a single well-defined object --- is undermined by two studies.
...
The conventional survival approach frames sepsis prediction as a Cox
proportional-hazards model. On MIMIC-IV, the Schoenfeld residual test rejects
proportional hazards globally ($p < 10^{-16}$), as anticipated from Kasal et al.\
\parencite{kasal2004cox}. The appropriate
...
Most prior MIMIC-IV sepsis models benchmark against SIRS, qSOFA, and NEWS. Evans et al.\
