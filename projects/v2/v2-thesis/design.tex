...
of H1--H6 and the Benjamini--Hochberg-corrected exploratory subgroup families;
and the machine-readable analysis register that supplies the status tags used
...
stages sequentially or by phase. All intermediate outputs are Parquet
