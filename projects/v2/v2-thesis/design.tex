...
The pipeline is implemented as thirteen numbered, single-purpose scripts in
\texttt{v2-proj/}, each reading from a set of upstream artefacts and writing
one or more downstream artefacts to \texttt{v2-proj/output/}. No script
...
\caption{Directed acyclic graph of the V2 pipeline. Each box is a single
  ...
  \texttt{v2-proj/output/}. Raw MIMIC-IV and eICU data are read-only.}
