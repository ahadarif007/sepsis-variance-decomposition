...
Outputs: \texttt{model\_primary\_A/B/C.rds}, coefficient tables,
\texttt{predictions\_primary\_A/B/C.parquet}, and the corresponding
\texttt{\_ablated} files.
...
Outputs: model objects, predictions, feature importance tables, Schoenfeld
test results, and the ablated GBT predictions.
...
describes the layout and the reproduction procedure.
