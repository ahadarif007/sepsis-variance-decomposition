...
write.csv(metrics, file.path(OUT, "10_tier1_metrics.csv"), row.names = FALSE)
```
...
write.csv(coefs, file.path(OUT, "10_tier1_coefs.csv"), row.names = FALSE)
...
arrow::write_parquet(data.frame(stay_id = lm6$stay_id, onset_within_h = y,
          ...
          file.path(OUT, "10_tier1_oos_pred.parquet"))
```
