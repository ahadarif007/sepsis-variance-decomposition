---
title: "Analysis 2: Dynamic Landmark Supermodel"
...
Vitals and scores receive median imputation, consistent with the Analysis 1 scheme. Labs and slopes are median/zero-imputed and paired with binary "measured" indicators to preserve the informative-missingness signal.
...
Out-of-sample AUROC at each prediction hour for both models, saved to `analysis2_auc_by_landmark.csv` and `analysis2_supermodel_oos.csv`.
...
write.csv(tab, file.path(OUT, "12_analysis2_auc_by_landmark.csv"), row.names=FALSE)
arrow::write_parquet(data.frame(stay_id=st$stay_id, landmark_time=st$landmark_time,
                     onset_within_h=y, risk=oos),
          file.path(OUT, "12_analysis2_supermodel_oos.parquet"))
